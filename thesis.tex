...
\documentclass[a4paper,12pt,table]{common/PhDThesisPSnPDF}
...
%\input{Appendix/fcsdataformat} 
%\input{Appendix/compensation} 
...
%\input{Appendix/il2-normalisation}
\input{Appendix/il2-association}
\end{appendices}

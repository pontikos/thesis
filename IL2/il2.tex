...
\myfigure{scale=1}{nonlymphocytes-KM00782Z-2012-07-23}
...
Outside of the lymphocyte cluster, I attempted to identify the subset of cells with slightly larger forward scatter, that I reported as \texttt{SPADE.1} in \Cref{figure:final-nonlymphocytes-clusters}.
Since I am now only interested in forward and side scatter, instead of using RPART as in \Cref{figure:scatter-rpart-128bin-var-pstat5} or SPADE, I chose to use a fixed grid on forward and side scatter.

...
An alternative to clustering aross samples is to use binning instead to partition the space into hypercubes in which the proportion
...
This is the approach taken by the \BioConductor{flowFP}.  \citep{Rogers:2008ij,Rogers:2009ff} 
...
%\begin{figure}[h]
  %\centering
%\begin{subfigure}[b]{.4\textwidth}
  %\includegraphics[scale=.4]{figures/CB00406Q-0U-2012-06-12.pdf}
%\caption{Resting sample.}
%\end{subfigure}
%\begin{subfigure}[b]{.4\textwidth}
  %\includegraphics[scale=.4]{figures/CB00406Q-01U-2012-06-12.pdf}
  %\caption{0.1 units}
%\end{subfigure}
%\begin{subfigure}[b]{.4\textwidth}
  %\includegraphics[scale=.4]{figures/CB00406Q-10U-2012-06-12.pdf}
  %\caption{10 units}
%\end{subfigure}
%\begin{subfigure}[b]{.4\textwidth}
  %\includegraphics[scale=.4]{figures/CB00406Q-1000U-2012-06-12.pdf}
  %\caption{1000 units}
%\end{subfigure}
%\mycaption{figure:spade-output}
...
\myfigure{scale=.5}{spade-pstat5mfi}
{pSTAT5 coloured \gls{MST} generated by applying \gls{SPADE} on lymphocytes (k=712).}
{
  The \gls{MST} was constructed from running \gls{SPADE} on the core surface markers,
  CD25, CD3, CD4, CD45RA, CD56, CD8 and FOXP3, in the manually gated lymphocyte subset, of four samples from one individual,
...
\myfigure{scale=.75}{spade-celltypes}
...
\myfigure{scale=.5}{responsive-lymphocyte-subset}
...
\myfigure{scale=.5}{notlymphocytes-spade-pstat5mfi}

...
One concern was that the Tregs gating was not particulary thorough.
%nor consistent
...
as well as NK cell markers, CD3, CD8, and CD56, and the naive cell marker CD31, to discover whether other potential cell subsets
...
\begin{tabular}{llll}
  \hline
Individual &  T1D & pch & number of days between visits \\
  \hline
1 & 0 & a & 98 \\
2 & 1 & b & 140 \\
3 & 0 & c & 167 \\
...
\begin{figure}[h]
\centering
\includegraphics[scale=.6]{figures/dose-effect-pstat5-cellsubsets-density.pdf}
...
In order to be rigorous, I first decided to assess the repeatability in the unstimulated sample.
To that purpose I considered the following pSTAT5 cell phenotypes in the four cell subsets:
...
The sensitivity of the response in these cell subsets is confirmed by plotting proleukin dose against  (\Cref{figure:dose-effect-pstat5-cellsubsets}).
...
Provided the distribution is unimodal then a shift in the peak of the pSTAT5 density should correspond to the difference in the MFI,
...
However for the stimulation data, beads on the Alexa-488 fluorochrome, used for pSTAT5 (\Cref{table:IL2-panels}),
%\Cref{chapter:il2ra}
...
However, other cells may respond and this study of ex vivo stimulated whole blood offers a chance to explore this.
...
Researches working in low dimensional data typically begin with visualisation.

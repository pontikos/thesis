...
\Cref{figure:ann-join-0U-01U} confirms that the clusters are conserved across the nearest-neighbour mapping.
...
The sensitivity of the response in these cell subsets is confirmed by plotting of dose against MFI (\Cref{figure:pstat5-response-cellsubsets-gate}).
...
proportions may vary across days and \cytokine{IL-2} dose.
...
\paragraph{Identification of highly sensitive cells}

...
In order to assess whether these identified subsets were real and not artefacts, I tried to identify them in other k samples analysed with the same panel.
%The population
...
Within the lymphocytes, at the lowest 0.1 units proleukin dose, CD25 explains a significant proportion of the pSTAT5 response, however at higher, 10 and 1000 units doses, the other trimeric receptors, CD122 and CD132 are likely to become more influential, since the CD56\positive subset \texttt{RPART.1} shows response at 10 units in spite of having very low CD25 (\Cref{figure:final-lymphocytes-clusters}).

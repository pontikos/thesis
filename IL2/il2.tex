...
The previous approach uses the core markers to cluster the data across batches (aliquots of the same sample stimulated at different concentrations of proleukin),

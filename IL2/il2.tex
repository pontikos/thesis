...
The remaining three were stimulated ex-vivo for 30 minutes at three 100-fold increasing doses
...
He presented his results in six of the ten repeated individuals for the four stimulated cell subsets, memory Teffs (\Cref{figure:tony-memory-eff}), memory Tregs (\Cref{figure:tony-memory-treg}), naive Teffs (\Cref{figure:tony-naive-eff}) and naive Tregs (\Cref{figure:tony-naive-treg}).

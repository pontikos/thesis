...
The second method, \texttt{post.thresh}, considers the ratio of both components in order to decide where to draw a threshold.
...
Also I notice that in \texttt{post.thresh}, in certain samples,  the posterior probability does reach thresholds beyond $89$ (\Cref{figure:cd45ra-posterior-threshold-fail}).
...
\begin{figure}[h]
\centering
  \includegraphics[width=.5\textwidth]{IL2RA/figures/cd45ra-threshold-example.pdf}
...
\begin{figure}[h]
\centering
  \includegraphics[width=.5\textwidth]{IL2RA/figures/cd45ra-posterior-threshold-fail.pdf}
...
Using both approaches, the agreement with manual of the memory CD25 MFI is good (\Cref{figure:cd25mfi-memory-auto-manual-agreement}).

...
\begin{tabular}{lllllll}
  \hline
         &  pch      & visit 1           & visit 2           & difference (days) \\
  \hline
  1      &  a      & 2008-03-04      & 2008-09-16      & 196 \\
  2      &  b      & 2008-02-20      & 2008-10-02      & 225 \\
  3      &  c      & 2008-02-28      & 2008-10-02      & 217 \\
  4      &  d      & 2008-03-26      & 2008-10-09      & 197 \\
  5      &  e      & 2008-04-10      & 2008-09-18      & 161 \\
  6      &  f      & 2008-04-16      & 2008-09-16      & 153 \\
  7      &  g      & 2008-05-08      & 2008-09-18      & 133 \\
  8      &  h      & 2008-05-12      & 2008-09-22      & 133 \\
  \st{9} &  \st{i} & \st{2008-05-06} & \st{2008-09-18} & \st{135} \\
  10     &  j      & 2008-05-22      & 2008-09-16      & 117 \\
  11     &  k      & 2008-05-29      & 2008-09-18      & 112 \\
  12     &  l      & 2008-05-29      & 2008-09-18      & 112 \\
  13     &  m      & 2008-05-29      & 2008-09-22      & 116 \\
  14     &  n      & 2008-06-12      & 2008-10-09      & 119 \\
  15     &  o      & 2008-06-16      & 2008-09-22      & 98 \\
  16     &  p      & 2008-07-15      & 2008-10-02      & 79  \\
  \hline
\end{tabular}
\mycaption{table:IL2RA-recalled-individuals}
{Recalled indiviuals.}
...
% Calli's results
% cell phenotypes
Two of these cell phenotypes, percent of CD25+ naive cells and CD25 MFI of memory cells, were found to be associated with SNPs in the \gene{IL2RA}.
Percent of CD25+ naive cells and percent of memory cells, were found to be associated with age and marginally associated with sex.
...
\begin{itemise}
\item Univariate gating on \protein{CD25} to threshold naive cells into positive and negative subsets, in order to obtain the percentage of CD25+ naive cells.
...
%%% CD25POS
\section{Univariate Gating on CD25: defining a CD25+ threshold on naive cells}
...
the CD25+ threshold is set manually using an ad-hoc process based on an isotype control, bead data and ultimately a judgement call
by the manual gater.
...
%Thus we define a threshold to distinguish CD25+ from CD25 negative cells using the automatically gated bead data on the day which the sample was ran.
...
{
  Except for individual d, the agreement of \texttt{beads.thresh} with manual for percentage of CD25+ naive cells
  is very good.  $r^2$ is the Pearson correlation squared.
}
\end{figure}

Hence the CD25+ threshold defined by my approach, \texttt{beads.thresh}, is set as the $86^{th}$ percentile of the automatically gated blank bead population on that day.
...
The \texttt{beads.thresh} method for setting \protein{CD25} thresholds  shows improved repeatability of the percentage of \protein{CD25}+ naive T cell phenotype
...
{
Repeatability of the percentage of naive cells which are CD25+ from day one to day two.
...
Overall, the association test with the percent CD25+ naive cells phenotype yields similar effect sizes to manual (\Cref{table:naive-cd25pos-association}).
...
On the other hand, \texttt{beads.thresh} adds some evidence to the suggested association by \citet{Dendrou:2009dv} of a sex effect on percentage of CD25+ naive cells,
whereby males have a lower percentage of naive CD25+ than females, although the effect remains marginal.
...
{Genotype, age and sex effect sizes on percentage of \protein{CD25}+ cells.}
{
...
{Repeatability and effect sizes of percentage of naive \protein{CD25}+, \protein{CD25} MEF and percentage of memory cell phenotypes.}
{

...
\begin{figure}[h]
\centering
\includegraphics[width=.5\textwidth]{figures/naive-cd25pos-beads-manual-agreement.pdf}
...
\begin{subfigure}[b]{.4\textwidth}
    \centering
    \includegraphics[scale=.35]{figures/rs2104286-ratio.pdf}
    \caption{}
\end{subfigure}
~
\begin{subfigure}[b]{.4\textwidth}
    \centering
    \includegraphics[scale=.35]{figures/rs2104286-ratio-cooks-distance.pdf}
    \caption{}
\end{subfigure}

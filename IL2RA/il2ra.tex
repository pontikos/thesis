...
\myfigure{scale=.5}{il2ra-samples-time}
%\begin{figure}[h]
%\centering
...
%\myfigure{scale=.5}{il2ra-manual-gating-strategy}
\myfigure{scale=.6}{il2ra-manual-gating-strategy3}
...
\myfigure{scale=0.6}{memory-CD25-MFI-time-effect}
...
For example, when deciding on the position of the CD25\positive gate on the naive cell subset (\Cref{figure:il2ra-manual-gating-strategy}d), the manual gater 
...
Applying the bead normalisation to the memory CD25 MFI from \Cref{figure:memory-CD25-MFI-time-effect}, we improve on the repeatability of that 

...
Automation can be achieved as long as we can break down the gating process into a series of basic steps. 
...
Perhaps a more general benchmark could be is the result useful?
...
We will only reap the true fruits of automated analysis once the number of samples has grown considerably, although this might require earlier steps in the process such as the processing of samples to be furhter standardised and automated first.

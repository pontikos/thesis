...
For example, in \Cref{chapter:kir}, I used prior information about the copy number of the \gene{KIR3DL1}/\gene{KIR3DS1} genes, obtained from qPCR, in order to identify predictive clusters in the SNP dataset.

...
Poor reproducibility is in part due to the heterogeneity underlying the same phenotype.
...
However, clusters can be defined in relation to one another, for example memory cells are lower for \protein{CD45RA} but higher in CD25 than naive cells (\Cref{chapter:il2ra}).

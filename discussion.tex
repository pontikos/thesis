...
It is fast, since points can be eliminated at each step reducing the number of points that needs to be considered at each clustering step.
...
it easily misses populations and imposes a directionality in cell lineages which may not always be correct.
...
The bias, since imposes an ordering on the markers and thus an an importance to the markers.  It may be more ambiguous markers are gated on first.  The RF gives us some idea of the importance of the markers.

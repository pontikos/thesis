...
The anlaysis of the type of datasets generated by this technology benefits greatly from the multidimensional visualisation techniques such as SPADE\citep{Simonds:2011jha} and ViSNE\citep{Amir:2013dc}.
...
These high-dimensional datasets require visualisation and Dana Pe'er group at Columbia University has devised various tools to do so such as ViSNE \citep{Amir:2013dc}.
...
Data quality can be as important as the methods: sophisticated methods are no replacement for good data.
...
Philosophically that what still makes data analysis an art.
